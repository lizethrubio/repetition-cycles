...
public class Exercise16 {
    ...
    public static void main(String[] args) {
        ...
        int hoursWorkaholic = 0; //horas del mas trabajador del lunes
        ...
        for (int i = 0; i < names.length; i++) {
            System.out.println("Ingrese el nombre del trabajador No. " + (i+1) + ": ");
            ...
            for (int j = 0; j < hours[i].length; j++) {
                System.out.println("Ingrese las horas laboradas por el trabajador " + names[i] + " en el dìa de la semana No. " + (j+1));
